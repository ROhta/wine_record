...
| `.github/instructions/pr-review.instructions.md` / `.github/instructions/language.instructions.md` | `apm install` で生成（base 由来）。クラウドの Copilot Code Review 用に例外的に追跡 | ✅ 追跡する |
